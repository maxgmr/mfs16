...
const DEFAULT_CONFIG_MESSAGE: &str = "# Do not edit this file! This default configuration was automatically generated.\n# Edit config.toml (in the same directory) instead.\n\n";
/// The message printed before the contents of the config file.
const CONFIG_MESSAGE: &str = "# Generated from default.toml.\n# Edit this file to your heart's content. Any missing values will be replaced by their default values.\n# Thank you for using my program!\n\n";
