...
impl FromStr for Operation {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match &s.to_lowercase()[..] {
            ...
            "cvm" => Ok(Operation::Cvm),
            "cvmi" => Ok(Operation::Cvmi),
            "cvmd" => Ok(Operation::Cvmd),
...
pub fn instr_to_bytes(
    ...
    match (operation, operand_1, operand_2) {
        ...
        (Operation::Cvm, BregDeref(bra), None) => Ok(i2b(CvmBra(*bra))),
        (Operation::Cvmi, BregDeref(bra), None) => Ok(i2b(CvmiBra(*bra))),
        (Operation::Cvmd, BregDeref(bra), None) => Ok(i2b(CvmdBra(*bra))),
