...
impl Instruction {
    ...
    pub fn from_opcode(opcode: u16) -> Self {
        ...
        match (nib_1, nib_2, nib_3, nib_4) {
            ...
            (0x0, 0x9, 0x7, bra) => LdiBraImm16(Reg32::from_nib(bra)),
            (0x0, 0x9, 0x8, bra) => LddBraImm16(Reg32::from_nib(bra)),
            ...
            (0x5, 0x0, ra, rb) if ra < NUM_REGS && rb < NUM_REGS => {
                MuluRaRb(Reg16::from_nib(ra), Reg16::from_nib(rb))
            }
            (0x5, 0x1, ra, rb) if ra < NUM_REGS && rb < NUM_REGS => {
                MuliRaRb(Reg16::from_nib(ra), Reg16::from_nib(rb))
            }
            (0x5, 0x2, ra, rb) if ra < NUM_REGS && rb < NUM_REGS => {
                DivuRaRb(Reg16::from_nib(ra), Reg16::from_nib(rb))
            }
            (0x5, 0x3, ra, rb) if ra < NUM_REGS && rb < NUM_REGS => {
                DiviRaRb(Reg16::from_nib(ra), Reg16::from_nib(rb))
            }
            (0x5, 0x0, bra, brb) => MuluBraBrb(
                Reg32::from_nib(bra - NUM_REGS),
                Reg32::from_nib(brb - NUM_REGS),
            ),
            (0x5, 0x1, bra, brb) => MuliBraBrb(
                Reg32::from_nib(bra - NUM_REGS),
                Reg32::from_nib(brb - NUM_REGS),
            ),
            (0x5, 0x2, bra, brb) => DivuBraBrb(
                Reg32::from_nib(bra - NUM_REGS),
                Reg32::from_nib(brb - NUM_REGS),
            ),
            (0x5, 0x3, bra, brb) => DiviBraBrb(
                Reg32::from_nib(bra - NUM_REGS),
                Reg32::from_nib(brb - NUM_REGS),
            ),
            (0x5, 0x4, vra, vrb) => MuluVraVrb(Reg8::from_nib(vra), Reg8::from_nib(vrb)),
            (0x5, 0x5, vra, vrb) => MuliVraVrb(Reg8::from_nib(vra), Reg8::from_nib(vrb)),
            (0x5, 0x6, vra, vrb) => DivuVraVrb(Reg8::from_nib(vra), Reg8::from_nib(vrb)),
            (0x5, 0x7, vra, vrb) => DiviVraVrb(Reg8::from_nib(vra), Reg8::from_nib(vrb)),
            (0x5, 0x8, ra, brb) => MuluRaBrb(Reg16::from_nib(ra), Reg32::from_nib(brb)),
            (0x5, 0x9, ra, brb) => MuliRaBrb(Reg16::from_nib(ra), Reg32::from_nib(brb)),
            (0x5, 0xA, ra, brb) => DivuRaBrb(Reg16::from_nib(ra), Reg32::from_nib(brb)),
            (0x5, 0xB, ra, brb) => DiviRaBrb(Reg16::from_nib(ra), Reg32::from_nib(brb)),
            (0x5, 0xC, 0x0, ra) => MuluRaImm16(Reg16::from_nib(ra)),
            (0x5, 0xC, 0x1, ra) => MuliRaImm16(Reg16::from_nib(ra)),
            (0x5, 0xC, 0x2, ra) => DivuRaImm16(Reg16::from_nib(ra)),
            (0x5, 0xC, 0x3, ra) => DiviRaImm16(Reg16::from_nib(ra)),
            (0x5, 0xC, 0x4, bra) => MuluBraImm32(Reg32::from_nib(bra)),
            (0x5, 0xC, 0x5, bra) => MuliBraImm32(Reg32::from_nib(bra)),
            (0x5, 0xC, 0x6, bra) => DivuBraImm32(Reg32::from_nib(bra)),
            (0x5, 0xC, 0x7, bra) => DiviBraImm32(Reg32::from_nib(bra)),
            (0x5, 0xC, 0x8, vra) => MuluVraImm8(Reg8::from_nib(vra)),
            (0x5, 0xC, 0x9, vra) => MuliVraImm8(Reg8::from_nib(vra)),
            (0x5, 0xC, 0xA, vra) => DivuVraImm8(Reg8::from_nib(vra)),
            (0x5, 0xC, 0xB, vra) => DiviVraImm8(Reg8::from_nib(vra)),
            (0x6, 0x0, 0x0, ra) => RandRa(Reg16::from_nib(ra)),
            (0x6, 0x0, 0x1, bra) => RandBra(Reg32::from_nib(bra)),
            (0x6, 0x0, 0x2, vra) => RandVra(Reg8::from_nib(vra)),
