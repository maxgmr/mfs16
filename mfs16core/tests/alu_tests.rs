use mfs16core::{
    gen_mem, Addr, Computer, Flag::*, Flags, Instruction::*, MemWritable, Memory, Reg, Reg16::*,
    Reg32::*, Reg8::*,
};
...
fn test_add() {
    ...
    c.mmu.write_word(0x00_0000, 0x1101);
    ...
    c.mmu.write_word(0x00_0002, 0x1123);
    ...
    c.mmu.write_word(0x00_0004, 0x1145);
    ...
    c.mmu.write_word(0x00_0006, 0x1167);
    ...
    c.mmu.write_word(0x00_0008, 0x1001);
    ...
    c.mmu.write_word(0x00_000A, 0x1023);
    ...
    c.mmu.write_word(0x00_000C, 0x1045);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_000E));
    ...
    c.mmu.write_word(0x00_000E, 0x1066);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0010));
    ...
    c.mmu.write_word(0x00_0010, 0x1078);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0012));
    ...
    c.mmu.write_word(0x00_0012, 0x1307);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0014));
    ...
    c.mmu.write_word(0x00_0014, 0x1262);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0016));
    ...
    c.mmu.write_word(0x00_0016, 0x1287);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0018));
    ...
    c.mmu.write_word(0x00_0018, 0x13AB);
    ...
    c.cpu.set_vreg(H1, 0b0111_1111);
    c.cpu.set_vreg(H0, 0b0000_0001);
    c.mmu.write_word(0x00_001A, 0x13BA);
    ...
    c.cpu.set_flag(Carry);
    c.mmu.write_word(0x00_001C, 0x184D);
    c.mmu.write_byte(0x00_001E, 0x54);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_001E));
    ...
    // ADC L0,0x03
    c.cpu.set_flag(Carry);
    c.mmu.write_word(0x00_001F, 0x185D);
    c.mmu.write_byte(0x00_0021, 0x03);
    ...
    // Do operation, set flags
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0022));
    assert_eq!(c.cpu.vreg(L0), 0x9D);
    assert_eq!(c.cpu.flags, Flags::from_string("zcopN"));

    // ADD A,0x1234
    c.cpu.set_reg(A, 0x8765);
    c.mmu.write_word(0x00_0022, 0x1800);
    c.mmu.write_word(0x00_0024, 0x1234);
    ...
    // Do operation, set flags
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0026));
    assert_eq!(c.cpu.reg(A), 0x9999);
    assert_eq!(c.cpu.flags, Flags::from_string("zcopN"));

    // ADC A,0x0000
    c.cpu.set_flag(Carry);
    c.mmu.write_word(0x00_0026, 0x1810);
    c.mmu.write_word(0x00_0028, 0x0000);
    ...
    // Do operation, set flags
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_002A));
    assert_eq!(c.cpu.reg(A), 0x999A);
    assert_eq!(c.cpu.flags, Flags::from_string("zcoPN"));

    // ADD BC,0x7654_3210
    c.cpu.set_breg(BC, 0x2345_6789);
    c.mmu.write_word(0x00_002A, 0x1820);
    c.mmu.write_word(0x00_002C, 0x3210);
    c.mmu.write_word(0x00_002E, 0x7654);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_002C));
    ...
    assert_eq!(c.cpu.breg(BC), 0x2345_6789);
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0030));
    assert_eq!(c.cpu.breg(BC), 0x2345_6789);
    ...
    // ADC BC,0x6666_6666;
    c.cpu.set_flag(Carry);
    c.mmu.write_word(0x00_0030, 0x1830);
    c.mmu.write_word(0x00_0032, 0x6666);
    c.mmu.write_word(0x00_0034, 0x6666);

    // Read instruction
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0032));
    assert_eq!(c.cpu.breg(BC), 0x9999_9999);

    // Read imm32
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0034));
    assert_eq!(c.cpu.breg(BC), 0x9999_9999);
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0036));
    assert_eq!(c.cpu.breg(BC), 0x9999_9999);
    ...
    c.mmu.write_word(0x65_6565, 0x1234);
    c.cpu.set_reg(L, 0xFFFF);
    c.mmu.write_word(0x00_0036, 0x1961);

    // Read instr
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0038));
    assert_eq!(c.cpu.reg(L), 0xFFFF);
    ...
    c.mmu.write_word(0x004B_4B4B, 0x0000);
    c.mmu.write_word(0x00_0038, 0x1A60);

    // Read instr
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_003A));
    assert_eq!(c.cpu.reg(L), 0x1233);
...
fn test_sub() {
    ...
    c.cpu.set_vreg(H0, 0b0000_0001);
    c.mmu.write_word(0x00_0000, 0x17AB);
    ...
    c.mmu.write_word(0x00_0002, 0x17BA);
    ...
    c.mmu.write_word(0x00_0004, 0x1400);
    ...
    c.mmu.write_word(0x00_0006, 0x1612);
    ...
    c.mmu.write_word(0x00_0008, 0x1576);
    ...
    // SBB D0,D1
    c.mmu.write_word(0x00_000A, 0x1776);
    ...
    c.mmu.write_word(0x00_000C, 0x1479);
    ...
    // SBB BC, HL
    c.mmu.write_word(0x00_000E, 0x1679);
    ...
    c.mmu.write_word(0x00_0010, 0x1862);
    c.mmu.write_word(0x00_0012, 0x1234);
    ...
    // SBB C,0x1111
    c.mmu.write_word(0x00_0014, 0x1872);
    c.mmu.write_word(0x00_0016, 0x1111);
    ...
    c.mmu.write_word(0x00_0018, 0x18A0);
    c.mmu.write_byte(0x00_001A, 0x01);

    // Read instr
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_001A));
    ...
    // SBB A1,0x02
    c.mmu.write_word(0x00_001B, 0x18B0);
    c.mmu.write_byte(0x00_001D, 0x02);
    ...
    c.mmu.write_word(0x00_001E, 0x1892);
    c.mmu.write_word(0x00_0020, 0x5678);
    c.mmu.write_word(0x00_0022, 0x1234);

    // Read instr
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0020));
    ...
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0024));
    assert_eq!(c.cpu.breg(HL), 0x789A_BCDE);
    ...
    c.cpu.set_flag(Carry);
    c.mmu.write_word(0x00_0024, 0x1892);
    c.mmu.write_word(0x00_0026, 0x0000);
    c.mmu.write_word(0x00_0028, 0x0000);
    ...
    // Read word 1 of imm32
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_0028));
    assert_eq!(c.cpu.breg(HL), 0x6666_6666);
    ...
    c.cpu.set_flag(Carry);
    c.cpu.set_breg(DE, 0x0065_6565);
    c.mmu.write_word(0x65_6565, 0x0124);
    c.cpu.set_reg(L, 0x8123);
    c.mmu.write_word(0x00_002A, 0x1B61);
    ...
    c.cpu.set_breg(BC, 0x004B_4B4B);
    c.mmu.write_word(0x004B_4B4B, 0x0000);
    c.mmu.write_word(0x00_002C, 0x1C60);
...
fn test_tcp() {
    ...
    c.mmu.write_word(0x00_0000, 0x1D04);
    ...
    c.mmu.write_word(0x00_0002, 0x1D10);
    ...
    // TCP D1
    c.cpu.set_vreg(D1, 0x01);
    c.mmu.write_word(0x00_0004, 0x1D26);
    ...
    // TCP D0 where D0 == 0
    c.cpu.set_vreg(D0, 0x00);
    c.mmu.write_word(0x00_0006, 0x1D27);
...
fn test_inc_dec() {
    ...
    c.mmu.write_word(0x00_0000, 0x1D60);
    ...
    // INC A
    c.cpu.flags = Flags::from_string("zcopn");
    c.mmu.write_word(0x00_0002, 0x1D30);
    ...
    c.mmu.write_word(0x00_0004, 0x1D42);
    ...
    // DEC HL
    c.cpu.flags = Flags::from_string("zcOpn");
    c.mmu.write_word(0x00_0006, 0x1D72);
    ...
    c.mmu.write_word(0x00_0008, 0x1D52);
    ...
    // DEC B1
    c.mmu.write_word(0x00_000A, 0x1D82);
...
fn test_pss() {
    ...
    c.mmu.write_word(0x00_0000, 0x1D95);
    ...
    c.mmu.write_word(0x00_0002, 0x1DA0);
    ...
    c.cpu.flags = starting_flags.clone();
    c.mmu.write_word(0x00_0004, 0x1DB7);
    c.cpu.set_flag(Overflow);
    ...
    // PSS imm16
    c.cpu.flags = starting_flags.clone();
    c.mmu.write_word(0x00_0006, 0x1DC0);
    c.mmu.write_word(0x00_0008, 0x9ABC);
    ...
    // PSS imm32
    c.mmu.write_word(0x00_000A, 0x1DC1);
    c.mmu.write_word(0x00_000C, 0xABCD);
    c.mmu.write_word(0x00_000E, 0x1234);
    ...
    // PSS imm8
    c.mmu.write_word(0x00_0010, 0x1DC2);
    c.mmu.write_byte(0x00_0012, 0x99);
...
fn test_and() {
    ...
    c.mmu.write_word(0x00_0000, 0x1E01);
    ...
    c.mmu.write_word(0x00_0002, 0x1F12);
    ...
    c.mmu.write_word(0x00_0004, 0x2045);
    ...
    c.mmu.write_word(0xFE_DCBA, 0b0101_0101_0101_0101);
    c.mmu.write_word(0x00_0006, 0x2112);
    ...
    c.mmu.write_word(0x00_0008, 0x2A03);
    c.mmu.write_word(0x00_000A, 0b0000_0000_1111_1111);
    ...
    c.mmu.write_word(0x00_000C, 0x2A10);
    c.mmu.write_word(0x00_000E, 0xF0F0);
    c.mmu.write_word(0x00_0010, 0x0F0F);
    ...
    c.mmu.write_word(0x00_0012, 0x2A2D);
    c.mmu.write_byte(0x00_0014, 0x81);
...
fn test_or() {
    ...
    c.cpu.set_reg(A, 0b1010_1010_1010_1010);
    c.cpu.set_reg(B, 0b1100_1111_0000_0101);
    c.mmu.write_word(0x00_0000, 0x2210);
    ...
    c.cpu
        .set_breg(HL, 0b0000_0000_0000_0000_1111_1111_1111_1111);
    c.mmu.write_word(0x00_0002, 0x2312);
    ...
    c.mmu.write_word(0x00_0004, 0x2445);
    ...
    c.cpu.set_breg(HL, 0xFE_DCBA);
    c.mmu.write_word(0xFE_DCBA, 0b1000_0100_0000_0011);
    c.mmu.write_word(0x00_0006, 0x2512);
    ...
    c.mmu.write_word(0x00_0008, 0x2A33);
    c.mmu.write_word(0x00_000A, 0b0000_0000_1111_1111);
    ...
    c.mmu.write_word(0x00_000C, 0x2A40);
    c.mmu.write_word(0x00_000E, 0xF0F0);
    c.mmu.write_word(0x00_0010, 0x0F0F);
    ...
    // OR L0,0x81
    c.cpu.set_vreg(L0, 0b0000_1111);
    c.mmu.write_word(0x00_0012, 0x2A5D);
    c.mmu.write_byte(0x00_0014, 0x81);
...
fn test_xor() {
    ...
    c.cpu.set_reg(A, 0b1010_1010_1010_1010);
    c.cpu.set_reg(B, 0b1100_1111_0000_0101);
    c.mmu.write_word(0x00_0000, 0x2610);
    ...
    c.cpu
        .set_breg(HL, 0b0000_0000_0000_0000_1111_1111_1111_1111);
    c.mmu.write_word(0x00_0002, 0x2712);
    ...
    c.mmu.write_word(0x00_0004, 0x2845);
    ...
    c.cpu.set_breg(HL, 0xFE_DCBA);
    c.mmu.write_word(0xFE_DCBA, 0b1000_0100_0000_0011);
    c.mmu.write_word(0x00_0006, 0x2912);
    ...
    c.cpu.set_reg(D, 0x0000);
    c.mmu.write_word(0x00_0008, 0x2A63);
    c.mmu.write_word(0x00_000A, 0b0000_0000_1111_1111);
    ...
    // XOR BC,0x0F0F_F0F0
    c.cpu.set_breg(BC, 0x1010_0101);
    c.mmu.write_word(0x00_000C, 0x2A70);
    c.mmu.write_word(0x00_000E, 0xF0F0);
    c.mmu.write_word(0x00_0010, 0x0F0F);
    ...
    // XOR L0,0x81
    c.cpu.set_vreg(L0, 0b0000_1111);
    c.mmu.write_word(0x00_0012, 0x2A8D);
    c.mmu.write_byte(0x00_0014, 0x81);
...
fn test_not() {
    ...
    // NOT A
    c.cpu.set_reg(A, 0b1010_1010_1010_1010);
    c.mmu.write_word(0x00_0000, 0x2A90);
    c.cpu.flags = Flags::from_string("ZCOPN");
    ...
    // NOT BC
    c.cpu.set_breg(BC, 0xFFFF_FFFF);
    c.mmu.write_word(0x00_0002, 0x2AA0);
    c.cpu.flags = Flags::from_string("zcopn");
    ...
    c.mmu.write_word(0x00_0004, 0x2AB6);
...
fn test_as() {
    ...
    // ASR A1,0
    c.mmu.write_word(0x00_0000, 0x2D00);
    ...
    // ASR A1,1
    c.mmu.write_word(0x00_0002, 0x2D01);
    ...
    // ASR A1,8
    c.mmu.write_word(0x00_0004, 0x2D08);
    ...
    c.mmu.write_word(0x00_0006, 0x2D49);
    c.cpu.flags = Flags::from_string("ZCOPN");
    ...
    // ASR B,0
    c.mmu.write_word(0x00_0008, 0x2B10);
    ...
    c.mmu.write_word(0x00_000A, 0x2B11);
    ...
    // ASR B,4
    c.mmu.write_word(0x00_000C, 0x2B14);
    ...
    c.mmu.write_word(0x00_000E, 0x2C20);
    ...
    // ASR HL,1
    c.mmu.write_word(0x00_0010, 0x2C21);
    ...
    c.mmu.write_word(0x00_0012, 0x2C1F);
...
fn test_rc() {
    ...
    c.mmu.write_word(0x00_0000, 0x3C00);
    c.cpu.set_vreg(A1, 0b1010_1010);
    c.cpu.flags = Flags::from_string("ZcOPN");
    ...
    c.mmu.write_word(0x00_0002, 0x3C04);
    c.cpu.set_vreg(A1, 0b1010_1010);
    c.cpu.flags = Flags::from_string("zcopn");
    ...
    // RCR A0,1; Carry set
    c.mmu.write_word(0x00_0004, 0x3C11);
    ...
    // RCR B1,2; Carry set
    c.mmu.write_word(0x00_0006, 0x3C22);
    ...
    // RCR B1,11; Carry set
    c.mmu.write_word(0x00_0008, 0x3C2B);
    ...
    c.mmu.write_word(0x00_000A, 0x3C38);
    ...
    c.cpu.flags = Flags::from_string("zCopn");
    c.cpu.set_reg(A, 0b1010_1010_1010_1010);
    c.mmu.write_word(0x00_000C, 0x3A00);
    ...
    // RCR A,1; Carry set
    c.mmu.write_word(0x00_000E, 0x3A01);
    ...
    c.mmu.write_word(0x00_0010, 0x3A1F);
    ...
    c.mmu.write_word(0x00_0012, 0x3B10);
    ...
    // RCR DE,1; Carry set
    c.mmu.write_word(0x00_0014, 0x3B11);
    ...
    c.mmu.write_word(0x00_0016, 0x3B2F);
    ...
    c.cpu.flags = Flags::from_string("ZCOPN");
    c.mmu.write_word(0x00_0018, 0x3F00);
    ...
    // RCL A1,1; Carry set
    c.cpu.flags = Flags::from_string("ZCoPN");
    c.mmu.write_word(0x00_001A, 0x3F01);

    // Read instr
    c.cycle();
    assert_eq!(c.cpu.pc, Addr::new_default_range(0x00_001C));
    assert_eq!(c.cpu.vreg(A1), 0x88);
    assert_eq!(c.cpu.flags, Flags::from_string("ZCoPN"));
    ...
    // RCL A1,10; Carry set
    c.mmu.write_word(0x00_001C, 0x3F0A);
    ...
    c.cpu.flags = Flags::from_string("");
    c.mmu.write_word(0x00_001E, 0x3D30);
    ...
    // RCL D,1; Carry reset
    c.mmu.write_word(0x00_0020, 0x3D31);
    ...
    c.mmu.write_word(0x00_0022, 0x3D4F);
    ...
    c.mmu.write_word(0x00_0024, 0x3E20);
    ...
    c.mmu.write_word(0x00_0026, 0x3E21);
    ...
    c.mmu.write_word(0x00_0028, 0x3E1F);
...
fn test_bit_changes() {
    ...
    let mut c = test_computer();
    c.mmu.write_word(0x12_3456, 0xFF00);
    BC.set(&mut c.cpu, 0x12_3456);
    c.mmu.write_word(0x00_0000, StbBraB(BC, 0).into_opcode());
    c.mmu.write_word(0x00_0002, RsbBraB(BC, 15).into_opcode());
    c.mmu.write_word(0x00_0004, TgbBraB(BC, 8).into_opcode());

    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0xFF00);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0xFF00);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0xFF01);
    ...
    assert_eq!(c.mmu.read_word(0x12_3456), 0xFF01);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0x7F01);
    ...
    assert_eq!(c.mmu.read_word(0x12_3456), 0x7F01);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0x7E01);
}
...
fn test_swap() {
    ...
    let mut c = test_computer();
    BC.set(&mut c.cpu, 0x12_3456);
    c.mmu.write_word(0x12_3456, 0x0123);
    c.mmu.write_word(0x00_0000, SwpBra(BC).into_opcode());

    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0x0123);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0x0123);
    c.cycle();
    assert_eq!(c.mmu.read_word(0x12_3456), 0x2301);
}
